...
get_wood_saprotrophs_traits <- function(traits_df) {
  primary_traits_df <- traits_df[traits_df$primary_lifestyle == "wood_saprotroph"
  ...
  secondary_traits_df <- traits_df[traits_df$Secondary_lifestyle == "wood_saprotroph"  
                                   & !is.na(traits_df$Secondary_lifestyle), ]
  wood_saprotroph_genera <- sort(unique(c(wood_saprotroph_genera, secondary_traits_df$GENUS)))
  
  wood_saprotroph_genus_traits_df <- rbind(primary_traits_df, secondary_traits_df)
